...
def main() -> None:
    ...
    resume_parser.add_argument("-b", "-q", "--batch-size", "--batch_size", dest="batch_size", type=int, default=None, help="Batch size override for resumed iterations")
    ...
    run_bm_parser.add_argument("-b", "-q", "--batch-size", "--batch_size", dest="batch_size", type=int, default=4, help="BO batch size per iteration")
